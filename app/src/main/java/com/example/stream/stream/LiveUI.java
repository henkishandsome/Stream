...
import com.example.stream.MainActivity;
import com.example.stream.PlayerActivity;
import com.example.stream.R;
import com.example.stream.stream.LiveActivity;
...
public class LiveUI implements View.OnClickListener {
    ...
    private void init() {
        ...
        btn_chat = activity.findViewById(R.id.btn_chat);
