...
import com.example.stream.service.GeniusService;
...
//			Log.w(TAG, e);
    ...
    private void refreshMobileIKSDKThreadStatusForDEBUG()
    {
        this.showDebugStatusImage(AutoReLoginDaemon.getInstance().isAutoReLoginRunning()?1:0
                , (ImageView) findViewById(R.id.demo_main_activity_layout_autoLoginFlagIV));
        this.showDebugStatusImage(KeepAliveDaemon.getInstance().isKeepAliveRunning()?1:0
                , (ImageView) findViewById(R.id.demo_main_activity_layout_keepAliveFlagIV));
        this.showDebugStatusImage(QoS4SendDaemon.getInstance().isRunning()?1:0
                , (ImageView) findViewById(R.id.demo_main_activity_layout_qosSendFlagIV));
        this.showDebugStatusImage(QoS4ReciveDaemon.getInstance().isRunning()?1:0
                , (ImageView) findViewById(R.id.demo_main_activity_layout_qosReceiveFlagIV));
    }

    private void initObserversForDEBUG()
    {
        AutoReLoginDaemon.getInstance().setDebugObserver(
                createObserverCompletionForDEBUG((ImageView) findViewById(R.id.demo_main_activity_layout_autoLoginFlagIV)));
        KeepAliveDaemon.getInstance().setDebugObserver(
                createObserverCompletionForDEBUG((ImageView) findViewById(R.id.demo_main_activity_layout_keepAliveFlagIV)));
        QoS4SendDaemon.getInstance().setDebugObserver(
                createObserverCompletionForDEBUG((ImageView) findViewById(R.id.demo_main_activity_layout_qosSendFlagIV)));
        QoS4ReciveDaemon.getInstance().setDebugObserver(
                createObserverCompletionForDEBUG((ImageView) findViewById(R.id.demo_main_activity_layout_qosReceiveFlagIV)));
    }
